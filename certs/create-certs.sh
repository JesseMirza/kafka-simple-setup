...
keytool -genkey -noprompt -keystore server3.keystore.jks -alias kafka3 -validity 1825 -keyalg RSA -dname "CN=kafka3, OU=KafkaTeam, O=KafkaNet, L=Amsterdam, S=NH, C=NL" -storepass test1234 -keypass test1234
keytool -genkey -noprompt -keystore server4.keystore.jks -alias kafka4 -validity 1825 -keyalg RSA -dname "CN=kafka4, OU=KafkaTeam, O=KafkaNet, L=Amsterdam, S=NH, C=NL" -storepass test1234 -keypass test1234
...
keytool -noprompt -keystore server3.truststore.jks -alias CARoot -import -file ca-cert -storepass test1234
keytool -noprompt -keystore server4.truststore.jks -alias CARoot -import -file ca-cert -storepass test1234
...
keytool -keystore server3.keystore.jks -alias kafka3 -certreq -file cert-file-server-3 -keypass test1234 -storepass test1234
keytool -keystore server4.keystore.jks -alias kafka4 -certreq -file cert-file-server-4 -keypass test1234 -storepass test1234
...
openssl x509 -req -CA ca-cert -CAkey ca-key -in cert-file-server-3 -out cert-signed-server-3 -days 1825 -CAcreateserial -passin pass:test1234
openssl x509 -req -CA ca-cert -CAkey ca-key -in cert-file-server-4 -out cert-signed-server-4 -days 1825 -CAcreateserial -passin pass:test1234
...
echo "Add CARoot and Signed Request to Server2 keystore"
keytool -keystore server3.keystore.jks -alias CARoot -import -file ca-cert -storepass test1234 -noprompt
keytool -keystore server3.keystore.jks -alias kafka3 -import -file cert-signed-server-3 -storepass test1234 -noprompt

echo "Add CARoot and Signed Request to Server2 keystore"
keytool -keystore server4.keystore.jks -alias CARoot -import -file ca-cert -storepass test1234 -noprompt
keytool -keystore server4.keystore.jks -alias kafka4 -import -file cert-signed-server-4 -storepass test1234 -noprompt
